...
from openminds.v5.core import SubjectGroupState as OMSubjectGroupState
...
class SubjectGroupState(KGObject, OMSubjectGroupState):
    ...
    reverse_properties = [
        ...
        Property(
            "is_input_to",
            ["openminds.v5.ephys.RecordingActivity", "openminds.v5.specimen_prep.TissueCulturePreparation"],
            "input",
            reverse="inputs",
            multiple=True,
        ...
        Property(
            "is_output_of",
            ["openminds.v5.core.ProtocolExecution", "openminds.v5.stimulation.StimulationActivity"],
            "output",
            reverse="outputs",
            multiple=True,
