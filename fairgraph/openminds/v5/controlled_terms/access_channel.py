...
from openminds.v5.controlled_terms import AccessChannel as OMAccessChannel
...
class AccessChannel(KGObject, OMAccessChannel):
    """
    <description not available>
    """
    ...
    reverse_properties = [
        ...
        Property(
            ...
            reverse="channel",
            multiple=True,
            description="reverse of 'channel'",
        ),
    ]
