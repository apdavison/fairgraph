...
from openminds.v5.controlled_terms import MRISpoilingTechnique as OMMRISpoilingTechnique
...
class MRISpoilingTechnique(KGObject, OMMRISpoilingTechnique):
    """
    <description not available>
    """
    ...
    reverse_properties = [
        ...
        Property(
            ...
            ["spoilingTechnique", "technique"],
            reverse=["spoiling_technique", "techniques"],
            multiple=True,
            description="reverse of spoiling_technique, techniques",
        ),
    ]
