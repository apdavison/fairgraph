...
from openminds.v5.controlled_terms import ProjectType as OMProjectType
...
class ProjectType(KGObject, OMProjectType):
    """
    <description not available>
    """

    type_ = "https://openminds.om-i.org/types/ProjectType"
