...
class WorkflowRecipeVersion(KGObject):
    ...
    fields = [
        ...
        Field("has_components", ["openminds.computation.WorkflowRecipeVersion", "openminds.core.File", "openminds.core.FileBundle", "openminds.core.SoftwareVersion"], "vocab:hasComponent", multiple=True, required=False,
