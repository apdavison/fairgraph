...
from openminds.v5.controlled_terms import NervousSystemStructure as OMNervousSystemStructure
...
class NervousSystemStructure(KGObject, OMNervousSystemStructure):
    """
    <description not available>
    """
