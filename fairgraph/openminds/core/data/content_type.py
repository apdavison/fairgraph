...
class ContentType(KGObjectV3):
    ...
    fields = [
        ...
        Field("related_media_type", str, "vocab:relatedMediaType", multiple=False, required=False,
        ...
        Field("specification", str, "vocab:specification", multiple=False, required=False,
