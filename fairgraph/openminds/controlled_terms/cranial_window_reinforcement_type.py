...
from openminds.latest.controlled_terms import CranialWindowReinforcementType
...
class CranialWindowReinforcementType(KGObject, CranialWindowReinforcementType):
    """
    <description not available>
    """
