...
from openminds.v5.controlled_terms import CommunicationProtocol as OMCommunicationProtocol
...
class CommunicationProtocol(KGObject, OMCommunicationProtocol):
    """
    <description not available>
    """
