...
from openminds.v5.controlled_terms import AnatomicalPlane as OMAnatomicalPlane
...
class AnatomicalPlane(KGObject, OMAnatomicalPlane):
    ...
    reverse_properties = [
        ...
        Property(
            "used_in",
            ["openminds.v5.neuroimaging.MRIScannerUsage", "openminds.v5.specimen_prep.SlicingDeviceUsage"],
            ["sliceOrientation", "slicingPlane"],
            reverse=["slice_orientation", "slicing_plane"],
            multiple=True,
            description="reverse of slice_orientation, slicing_plane",
        ),
    ]
