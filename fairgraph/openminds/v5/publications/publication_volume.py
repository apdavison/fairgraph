...
from openminds.v5.publications import PublicationVolume as OMPublicationVolume
...
class PublicationVolume(KGObject, OMPublicationVolume):
    ...
    reverse_properties = [
        Property(
            "has_parts",
            ["openminds.v5.publications.PublicationIssue", "openminds.v5.publications.ScholarlyArticle"],
            "isPartOf",
            reverse="is_part_of",
            multiple=True,
