...
from openminds.v5.controlled_terms import AccessEligibilityType as OMAccessEligibilityType
...
class AccessEligibilityType(KGObject, OMAccessEligibilityType):
    """
    <description not available>
    """
    ...
    reverse_properties = [
        ...
        Property(
            ...
            reverse="eligibility",
            multiple=True,
            description="reverse of 'eligibility'",
        ),
    ]
    ...
    def __init__(
        ...
        return KGObject.__init__(
            ...
            is_eligibility_of=is_eligibility_of,
