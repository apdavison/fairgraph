...
class Subject(KGObject):
    ...
    def __init__(self, lookup_label=None, biological_sex=None, internal_identifier=None, is_part_of=None, species=None, studied_states=None, id=None, data=None, space=None, scope=None):
        return super().__init__(id=id, data=data, space=space, scope=scope, lookup_label=lookup_label, biological_sex=biological_sex, internal_identifier=internal_identifier, is_part_of=is_part_of, species=species, studied_states=studied_states)