...
class WorkflowRecipeVersion(KGObject):
    ...
    properties = [
        Property("name", str, "vocab:fullName", doc="Whole, non-abbreviated name of the workflow recipe version."),
        Property(
            "alias",
            str,
            "vocab:shortName",
        ...
        Property("homepage", IRI, "vocab:homepage", doc="Main website of the workflow recipe version."),
        Property(
            "how_to_cite",
            str,
            "vocab:howToCite",
