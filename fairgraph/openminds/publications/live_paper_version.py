...
class LivePaperVersion(KGObject):
    ...
    fields = [
        ...
        Field("related_publications", ["openminds.publications.ScholarlyArticle", "openminds.publications.Chapter", "openminds.publications.Book", "openminds.core.DOI", "openminds.core.ISBN", "openminds.core.ISSN"], "vocab:relatedPublication", multiple=True, required=False,
