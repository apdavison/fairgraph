...
from openminds.v5.controlled_terms import MRIParallelAcquisitionTechnique as OMMRIParallelAcquisitionTechnique
...
class MRIParallelAcquisitionTechnique(KGObject, OMMRIParallelAcquisitionTechnique):
    """
    <description not available>
    """

    type_ = "https://openminds.om-i.org/types/MRIParallelAcquisitionTechnique"
    ...
    reverse_properties = [
        ...
        Property(
            ...
            ["parallelAcquisitionTechnique", "technique"],
            reverse=["parallel_acquisition_technique", "techniques"],
            multiple=True,
            description="reverse of parallel_acquisition_technique, techniques",
        ),
    ]
