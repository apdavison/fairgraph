...
from openminds.v5.controlled_terms import AccessProcessType as OMAccessProcessType
...
class AccessProcessType(KGObject, OMAccessProcessType):
    """
    <description not available>
    """

    type_ = "https://openminds.om-i.org/types/AccessProcessType"
    ...
    reverse_properties = [
        ...
        Property(
            ...
            reverse="process",
            multiple=True,
            description="reverse of 'process'",
        ),
    ]
