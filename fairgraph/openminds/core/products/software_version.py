...
class SoftwareVersion(KGObject):
    ...
    fields = [
        ...
        Field("digital_identifier", ["openminds.core.DOI", "openminds.core.RRID", "openminds.core.SWHID"], "vocab:digitalIdentifier", multiple=False, required=False,
