...
from openminds.v5.controlled_terms import DeviceMountingType as OMDeviceMountingType
...
class DeviceMountingType(KGObject, OMDeviceMountingType):
    """
    <description not available>
    """

    type_ = "https://openminds.om-i.org/types/DeviceMountingType"
    ...
    reverse_properties = [
        ...
        Property(
            ...
            "mountingType",
            reverse="mounting_type",
            multiple=True,
            description="reverse of 'mounting_type'",
        ),
    ]
    ...
    def __init__(
        ...
        return KGObject.__init__(
            ...
            is_mounting_type_of=is_mounting_type_of,
