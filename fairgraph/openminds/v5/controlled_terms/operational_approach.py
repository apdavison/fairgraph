...
from openminds.v5.controlled_terms import OperationalApproach as OMOperationalApproach
...
class OperationalApproach(KGObject, OMOperationalApproach):
    """
    <description not available>
    """

    type_ = "https://openminds.om-i.org/types/OperationalApproach"
