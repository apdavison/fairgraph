...
from openminds.v5.controlled_terms import OrganismSubstance as OMOrganismSubstance
...
class OrganismSubstance(KGObject, OMOrganismSubstance):
    ...
    reverse_properties = [
        ...
        Property(
            "sample",
            ["openminds.v5.core.TissueSample", "openminds.v5.core.TissueSampleCollection"],
            "origin",
            reverse="origin",
            multiple=True,
