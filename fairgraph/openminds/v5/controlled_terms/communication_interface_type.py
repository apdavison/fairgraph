...
from openminds.v5.controlled_terms import CommunicationInterfaceType as OMCommunicationInterfaceType
...
class CommunicationInterfaceType(KGObject, OMCommunicationInterfaceType):
    """
    <description not available>
    """
