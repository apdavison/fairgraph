...
from openminds.v5.controlled_terms import AnalysisTechnique as OMAnalysisTechnique
...
class AnalysisTechnique(KGObject, OMAnalysisTechnique):
    ...
    reverse_properties = [
        ...
        Property(
            ...
            ["gradientCorrection", "technique"],
            reverse=["gradient_correction", "techniques"],
            multiple=True,
            description="reverse of gradient_correction, techniques",
        ),
    ]
