...
from openminds.v5.controlled_terms import SovereignState as OMSovereignState
...
class SovereignState(KGObject, OMSovereignState):
    """
    <description not available>
    """
    ...
    reverse_properties = [
        Property(
            "applies_to",
            ["openminds.v5.core.Organization", "openminds.v5.core.UsageAgreement"],
            "jurisdiction",
            reverse="jurisdiction",
            multiple=True,
            description="reverse of 'jurisdiction'",
        ),
        Property(
            "describes",
            [
        ...
        Property(
            "is_country_of",
            "openminds.v5.core.Location",
            "country",
            reverse="country",
            multiple=True,
            description="reverse of 'country'",
        ),
    ]
