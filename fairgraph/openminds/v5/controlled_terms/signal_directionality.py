...
from openminds.v5.controlled_terms import SignalDirectionality as OMSignalDirectionality
...
class SignalDirectionality(KGObject, OMSignalDirectionality):
    """
    <description not available>
    """
    ...
    reverse_properties = [
        ...
        Property(
            ...
            reverse="signal_directionality",
            multiple=True,
            description="reverse of 'signal_directionality'",
        ),
    ]
