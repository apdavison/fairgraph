...
from openminds.v5.controlled_terms import AccessForm as OMAccessForm
...
class AccessForm(KGObject, OMAccessForm):
    """
    <description not available>
    """
