...
class LivePaperVersion(KGObject):
    ...
    existence_query_fields = ('digital_identifier', 'license', 'accessibility', 'full_documentation', 'release_date', 'alias', 'version_identifier', 'version_innovation')
