...
from openminds.v5.controlled_terms import ExternalBodyRegion as OMExternalBodyRegion
...
class ExternalBodyRegion(KGObject, OMExternalBodyRegion):
    """
    <description not available>
    """

    type_ = "https://openminds.om-i.org/types/ExternalBodyRegion"
    ...
    reverse_properties = [
        ...
        Property(
            "is_intended_location_of",
            "openminds.v5.neuroimaging.MRICoil",
            "intendedMountingLocation",
            reverse="intended_mounting_location",
            multiple=True,
            description="reverse of 'intended_mounting_location'",
        ),
        Property(
            "is_location_of",
            [
        ...
        Property(
            "is_mounting_location_of",
            "openminds.v5.neuroimaging.MRICoilUsage",
            "mountingLocation",
            reverse="mounting_location",
            multiple=True,
            description="reverse of 'mounting_location'",
        ),
        Property(
            "is_target_of",
            [
    ...
    def __init__(
        ...
        is_intended_location_of=None,
        is_location_of=None,
        is_mounting_location_of=None,
        is_target_of=None,
        ...
        return KGObject.__init__(
            ...
            is_intended_location_of=is_intended_location_of,
            is_location_of=is_location_of,
            is_mounting_location_of=is_mounting_location_of,
