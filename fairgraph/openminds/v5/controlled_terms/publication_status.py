...
from openminds.v5.controlled_terms import PublicationStatus as OMPublicationStatus
...
class PublicationStatus(KGObject, OMPublicationStatus):
    """
    <description not available>
    """
    ...
    reverse_properties = [
        ...
        Property(
            ...
            "publicationStatus",
            reverse="publication_status",
            multiple=True,
            description="reverse of 'publication_status'",
        ),
    ]
