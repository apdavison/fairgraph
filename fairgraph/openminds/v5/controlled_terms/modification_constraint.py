...
from openminds.v5.controlled_terms import ModificationConstraint as OMModificationConstraint
...
class ModificationConstraint(KGObject, OMModificationConstraint):
    """
    <description not available>
    """
