...
from openminds.v5.controlled_terms import PulseShape as OMPulseShape
...
class PulseShape(KGObject, OMPulseShape):
    """
    <description not available>
    """
    ...
    reverse_properties = [
        ...
        Property(
            ...
            "MTPulseShape",
            reverse="mt_pulse_shape",
            multiple=True,
            description="reverse of 'mt_pulse_shape'",
        ),
    ]
