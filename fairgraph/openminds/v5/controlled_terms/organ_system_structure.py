...
from openminds.v5.controlled_terms import OrganSystemStructure as OMOrganSystemStructure
...
class OrganSystemStructure(KGObject, OMOrganSystemStructure):
    """
    <description not available>
    """

    type_ = "https://openminds.om-i.org/types/OrganSystemStructure"
