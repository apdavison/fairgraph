...
from openminds.v5.controlled_terms import MRIFatSuppressionTechnique as OMMRIFatSuppressionTechnique
...
class MRIFatSuppressionTechnique(KGObject, OMMRIFatSuppressionTechnique):
    """
    <description not available>
    """

    type_ = "https://openminds.om-i.org/types/MRIFatSuppressionTechnique"
    ...
    reverse_properties = [
        ...
        Property(
            ...
            ["fatSuppressionTechnique", "technique"],
            reverse=["fat_suppression_technique", "techniques"],
            multiple=True,
            description="reverse of fat_suppression_technique, techniques",
        ),
    ]
