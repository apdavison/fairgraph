...
from openminds.v5.controlled_terms import AnatomicalAxesOrientation as OMAnatomicalAxesOrientation
...
class AnatomicalAxesOrientation(KGObject, OMAnatomicalAxesOrientation):
    ...
    reverse_properties = [
        ...
        Property(
            ...
            "specimenOrientation",
            reverse="specimen_orientation",
            multiple=True,
            description="reverse of 'specimen_orientation'",
        ),
    ]
