...
from openminds.v5.controlled_terms import SubjectAttribute as OMSubjectAttribute
...
class SubjectAttribute(KGObject, OMSubjectAttribute):
    ...
    type_ = "https://openminds.om-i.org/types/SubjectAttribute"
    ...
    reverse_properties = [
        ...
        Property(
            "is_attribute_of",
            ["openminds.v5.core.SubjectGroupState", "openminds.v5.core.SubjectState"],
            "attribute",
            reverse="attributes",
            multiple=True,
