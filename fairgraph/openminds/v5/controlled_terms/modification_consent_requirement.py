...
from openminds.v5.controlled_terms import ModificationConsentRequirement as OMModificationConsentRequirement
...
class ModificationConsentRequirement(KGObject, OMModificationConsentRequirement):
    """
    <description not available>
    """
    ...
    reverse_properties = [
        ...
        Property(
            ...
            "modificationProfile",
            reverse="modification_profiles",
            multiple=True,
            description="reverse of 'modification_profiles'",
        ),
    ]
