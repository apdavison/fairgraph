...
class ChemicalSubstance(KGObject):
    ...
    def __init__(self, lookup_label=None, additional_remarks=None, molecular_entity=None, product_source=None, purity=None, id=None, data=None, space=None, scope=None):
        return super().__init__(id=id, space=space, scope=scope, data=data, lookup_label=lookup_label, additional_remarks=additional_remarks, molecular_entity=molecular_entity, product_source=product_source, purity=purity)