...
class PatchClampActivity(KGObject):
    ...
    fields = [
        ...
        Field("description", str, "vocab:description", multiple=False, required=False,
              doc="Longer statement or account giving the characteristics of the patch clamp activity."),
        ...
        Field("outputs", "openminds.ephys.PatchedCell", "vocab:output", multiple=True, required=True,
