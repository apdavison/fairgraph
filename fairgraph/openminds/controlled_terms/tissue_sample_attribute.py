...
from openminds.latest.controlled_terms import TissueSampleAttribute as OMTissueSampleAttribute
...
class TissueSampleAttribute(KGObject, OMTissueSampleAttribute):
    """
    <description not available>
    """

    type_ = "https://openminds.om-i.org/types/TissueSampleAttribute"
    ...
    reverse_properties = [
        ...
        Property(
            ...
            reverse="attributes",
            multiple=True,
            description="reverse of 'attributes'",
        ),
    ]
