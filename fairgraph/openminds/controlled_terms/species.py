...
class Species(KGObject, OMSpecies):
    ...
    reverse_properties = [
        Property(
            ...
            ["openminds.latest.sands.BrainAtlas", "openminds.latest.sands.CommonCoordinateSpace"],
            "usedSpecies",
            reverse="used_species",
            multiple=True,
            description="reverse of 'used_species'",
        ),
        Property(
            "describes",
            [
    ...
    def __init__(
        ...
        return KGObject.__init__(
            ...
            data=data,
            name=name,
            common_coordinate_space=common_coordinate_space,
