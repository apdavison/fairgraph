...
latex_documents = [
    (
        ...
        "Andrew P. Davison, Onur Ates, Yann Zerlaut, Nico Feld, Glynis Mattheisen",
        "manual",
    ),
]
...
man_pages = [(master_doc, "fairgraph", "fairgraph Documentation", [author], 1)]
