...
class CoordinateSpace(KGObject):
    """
    Structured information on a coordinate space.
    """
    space = "model"
    ...
    fields = [
        ...
        Field("default_images", "openminds.sands.Image", "vocab:defaultImage", multiple=True, required=False,
        ...
        Field("name", str, "vocab:fullName", multiple=False, required=True,
              doc="Whole, non-abbreviated name of the coordinate space."),
        ...
        Field("alias", str, "vocab:shortName", multiple=False, required=True,
              doc="Shortened or fully abbreviated name of the coordinate space."),
