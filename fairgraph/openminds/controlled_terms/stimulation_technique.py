...
from openminds.latest.controlled_terms import StimulationTechnique as OMStimulationTechnique
...
class StimulationTechnique(KGObject, OMStimulationTechnique):
    """
    <description not available>
    """
