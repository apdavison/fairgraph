...
class WebServiceVersion(KGObject):
    ...
    fields = [
        ...
        Field("is_alternative_version_of", "openminds.computation.WebServiceVersion", "vocab:isAlternativeVersionOf", multiple=True, required=False,
              doc="Reference to an original form where the essence was preserved, but presented in an alternative form."),
        Field("is_new_version_of", "openminds.computation.WebServiceVersion", "vocab:isNewVersionOf", multiple=False, required=False,
