...
class BrainAtlasVersion(KGObject):
    ...
    fields = [
        ...
        Field("coordinate_space", "openminds.sands.CommonCoordinateSpaceVersion", "vocab:coordinateSpace", multiple=False, required=True,
        ...
        Field("has_terminology", "openminds.sands.ParcellationTerminologyVersion", "vocab:hasTerminology", multiple=False, required=True,
              doc="no description available"),
        ...
        Field("major_version_identifier", str, "vocab:majorVersionIdentifier", multiple=False, required=False,
              doc="no description available"),
        ...
        Field("type", "openminds.controlledterms.AtlasType", "vocab:type", multiple=False, required=False,
