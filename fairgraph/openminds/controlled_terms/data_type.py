...
from openminds.v4.controlled_terms import DataType as OMDataType
...
class DataType(KGObject, OMDataType):
    ...
    reverse_properties = [
        ...
        Property(
            "is_data_type_of",
            ["openminds.v4.computation.LocalFile", "openminds.v4.core.ContentType", "openminds.v4.core.File"],
            "dataType",
            reverse="data_types",
            multiple=True,
