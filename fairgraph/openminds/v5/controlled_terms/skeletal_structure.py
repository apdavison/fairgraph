...
from openminds.v5.controlled_terms import SkeletalStructure as OMSkeletalStructure
...
class SkeletalStructure(KGObject, OMSkeletalStructure):
    """
    <description not available>
    """

    type_ = "https://openminds.om-i.org/types/SkeletalStructure"
