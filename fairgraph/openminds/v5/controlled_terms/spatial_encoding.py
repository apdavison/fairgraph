...
from openminds.v5.controlled_terms import SpatialEncoding as OMSpatialEncoding
...
class SpatialEncoding(KGObject, OMSpatialEncoding):
    """
    <description not available>
    """
    ...
    reverse_properties = [
        ...
        Property(
            ...
            ["spatialEncoding", "technique"],
            reverse=["spatial_encoding", "techniques"],
            multiple=True,
            description="reverse of spatial_encoding, techniques",
        ),
    ]
