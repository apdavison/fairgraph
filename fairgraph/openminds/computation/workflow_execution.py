...
class WorkflowExecution(KGObject):
    ...
    fields = [
        ...
        Field("stages", ["openminds.computation.DataAnalysis", "openminds.computation.Optimization", "openminds.computation.Simulation", "openminds.computation.Visualization"], "vocab:stages", multiple=True, required=True,
              doc="no description available"),
