...
from openminds.v5.controlled_terms import BiologicalOrder as OMBiologicalOrder
...
class BiologicalOrder(KGObject, OMBiologicalOrder):
    ...
    reverse_properties = [
        ...
        Property(
            "used_in",
            ["openminds.v5.sands.AnatomicalAtlas", "openminds.v5.sands.CommonCoordinateFramework"],
            "usedTaxon",
            reverse="used_taxon",
            multiple=True,
            description="reverse of 'used_taxon'",
        ),
    ]
