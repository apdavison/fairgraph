...
from openminds.v5.controlled_terms import AgeReference as OMAgeReference
...
class AgeReference(KGObject, OMAgeReference):
    """
    <description not available>
    """

    type_ = "https://openminds.om-i.org/types/AgeReference"
