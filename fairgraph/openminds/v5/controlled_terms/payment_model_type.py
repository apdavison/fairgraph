...
from openminds.v5.controlled_terms import PaymentModelType as OMPaymentModelType
...
class PaymentModelType(KGObject, OMPaymentModelType):
    """
    <description not available>
    """
    ...
    reverse_properties = [
        ...
        Property(
            ...
            "paymentModel",
            reverse="payment_models",
            multiple=True,
            description="reverse of 'payment_models'",
        ),
    ]
    ...
    def __init__(
        ...
        return KGObject.__init__(
            ...
            is_payment_model_of=is_payment_model_of,
