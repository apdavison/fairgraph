...
from openminds.v5.controlled_terms import MuscularStructure as OMMuscularStructure
...
class MuscularStructure(KGObject, OMMuscularStructure):
    """
    <description not available>
    """

    type_ = "https://openminds.om-i.org/types/MuscularStructure"
