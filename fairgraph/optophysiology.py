...
class RegionOfInterest(KGObject):
    ...
    def __init__(self, name, origin=None, x=None, y=None, shape=None, size=None, classification=None, description=None, id=None, instance=None):
        args = locals()
        args.pop("self")
...
class TwoPhotonImaging(KGObject):
    ...
    def __init__(self, name, cranial_window, image_sequence, microscope=None, brain_state=None, anesthesia=None, laser=None, excitation_wavelength=None, power_at_objective=None, collection_wavelength=None, imaging_depth=None, start_time=None, end_time=None, protocol=None, people=None, id=None, instance=None):
        args = locals()
        args.pop("self")
        KGObject.__init__(self, **args)
